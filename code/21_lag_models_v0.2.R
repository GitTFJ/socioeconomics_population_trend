...
#source("background/full_wg_aV1.7.R")
#source("background/full_wg_a_lag10_V1.7.R")
#source("background/full_wg_a_lag0_V1.7.R")

full_wg_a0 = readRDS("full_wg_a_lag0.rds")
full_wg_a5 = readRDS("full_wg_a.rds")
full_wg_a10 = readRDS("full_wg_a_lag10.rds")
...
df = round(df,3)
write.csv(df, "Documents/ModellingTrends/Results/lag_fit.csv")
...
ggsave("lag_fit.png", width = 12, height = 7)
